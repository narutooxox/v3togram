...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            return
        buttons = [[
            InlineKeyboardButton('𝐇𝐨𝐰 𝐓𝐨 𝐔𝐬𝐞 𝐌𝐞', url=f"https://t.me/{temp.U_NAME}?start=start")
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"›› 𝐓𝐡𝐚𝐧𝐤 𝐲𝐨𝐮 𝐭𝐨 𝐚𝐝𝐝 𝐦𝐞 𝐢𝐧 𝐲𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩.\n›› 𝐃𝐨𝐧'𝐭 𝐟𝐨𝐫𝐠𝐞𝐭 𝐭𝐨 𝐦𝐚𝐤𝐞 𝐦𝐞 𝐀𝐝𝐦𝐢𝐧.\n›› 𝐈𝐬 𝐀𝐧𝐲 𝐃𝐨𝐮𝐛𝐭𝐬 𝐀𝐛𝐨𝐮𝐭 𝐔𝐬𝐢𝐧𝐠 𝐌𝐞 𝐂𝐥𝐢𝐜𝐤 𝐁𝐞𝐥𝐨𝐰 𝐁𝐮𝐭𝐭𝐨𝐧..⚡⚡.",
            reply_markup=reply_markup)
    else:
